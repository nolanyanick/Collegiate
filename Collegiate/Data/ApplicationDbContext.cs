    ...
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DriverOffer>().HasData(
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "3bf8d706-472e-4497-b4e6-111fb4ebf24c", DepartureTime = Convert.ToDateTime("4/15/2020 10:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/15/2020 12:30:00 PM"), ReturnTime = Convert.ToDateTime("4 / 15 / 2020 3:30:00 PM"), Campus= "Main Campus", ToNMC = true,  SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the Library Parking Lot", OfferClosed = false},
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "b17c6728-1008-4ebb-b39c-57a41f490b24", DepartureTime = Convert.ToDateTime("4/15/2020 3:30:00 PM"), ArrivalTime = Convert.ToDateTime("4/15/2020 5:30:00 PM"), AddressId = "0343fbc8-a866-4e7e-aaf6-b095f12a70ce", ToNMC = false, SeatsAvailable = 3, FromMeetLocationDesc= "I plan on picking people up at the Library Parking Lot", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "30836417-2d86-4fe2-b8b3-cbc964d8f46b", DepartureTime = Convert.ToDateTime("4/16/2020 11:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), ReturnTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), Campus = "Aero Park", ToNMC = true, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at main building enterance", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "4661cc56-b9cf-4704-9553-894aae98436a", DepartureTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), ArrivalTime = Convert.ToDateTime("4/16/2020 4:30:00 PM"), AddressId = "5d56bd1d-8bf7-4c2c-8b55-984186650386", Campus = "Main Campus", ToNMC = false, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the back of the parking lot at Walmart", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "6357d0f6-463a-44ba-887b-0648b6ba33dc", DepartureTime = Convert.ToDateTime("4/17/2020 9:00:00 AM"), ArrivalTime = Convert.ToDateTime("4/17/2020 10:30:00 PM"), ReturnTime = Convert.ToDateTime("4/17/2020 5:30:00 PM"), Campus = "Main Campus", ToNMC = true, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the Library Parking Lot", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "a87df131-18b8-4762-9d24-dc6e679458ba", DepartureTime = Convert.ToDateTime("4/17/2020 1:30:00 PM"), ArrivalTime = Convert.ToDateTime("4/17/2020 2:30:00 PM"), AddressId = "5d56bd1d-8bf7-4c2c-8b55-984186650386", Campus = "Main Campus", ToNMC = false, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the back of the parking lot at Walmart", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "adf3fbad-0ed9-4a9d-880b-1e8b2271bcdb", DepartureTime = Convert.ToDateTime("4/22/2020 10:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/22/2020 12:30:00 PM"), ReturnTime= Convert.ToDateTime("4/22/2020 3:30:00 PM"), Campus = "Main Campus", ToNMC = true, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the Library Parking Lot", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "c4436384-9cd1-453c-8880-30e1de5c71aa", DepartureTime = Convert.ToDateTime("4/22/2020 3:30:00 PM"), ArrivalTime = Convert.ToDateTime("4/22/2020 6:30:00 PM"), AddressId = "5d56bd1d-8bf7-4c2c-8b55-984186650386", Campus = "Main Campus", ToNMC = false, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the back of the parking lot at Walmart", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "26d39cb7-4b4d-4e99-860f-1465277e3adc", DepartureTime = Convert.ToDateTime("4/23/2020 11:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/23/2020 12:30:00 PM"), ReturnTime= Convert.ToDateTime("4/23/20 4:30:00 PM"), Campus = "Main Campus", ToNMC = true, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the Library Parking Lot", OfferClosed = false },
                new DriverOffer { DriverId = "546bded4-592c-4ee1-bc34-601c47049f1b", DriverOfferId = "1d0dfb0d-efdc-48eb-bc77-2c5b8520e5b0", DepartureTime = Convert.ToDateTime("4/23/2020 4:30:00 PM"), ArrivalTime = Convert.ToDateTime("4/23/2020 5:30:00 PM"), AddressId = "5d56bd1d-8bf7-4c2c-8b55-984186650386", Campus = "Main Campus", ToNMC = false, SeatsAvailable = 3, ToMeetLocationDesc = "I plan on dropping everybody off at the back of the parking lot at Walmart", OfferClosed = false }
                );

            modelBuilder.Entity<RiderRequest>().HasData(
                new RiderRequest { UserId = "B8C63411-A600-B238-E734-E0F4FDD505F0", RiderRequestId = "05378CE6-F765-4FC7-9F95-3B6E47633CFA", Campus = "Main", DepartureTime = Convert.ToDateTime("4/15/2020 10:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/15/2020 12:30:00 PM"), ToNMC = true, ReturnTime = Convert.ToDateTime("4/15/2020 3:30:00 PM"), OfferClosed = false, AddressId = "00000000-0000-0000-0000-000000000000"},
                new RiderRequest { UserId = "B8C63411-A600-B238-E734-E0F4FDD505F0", RiderRequestId = "F87EB0B8-F687-41FB-8973-D5211B01ACD3", DepartureTime = Convert.ToDateTime("4/15/2020 3:30:00 PM"), ToNMC = false, OfferClosed = false, AddressId = "0343fbc8-a866-4e7e-aaf6-b095f12a70ce" },
                new RiderRequest { UserId = "B8C63411-A600-B238-E734-E0F4FDD505F0", RiderRequestId = "5253DA99-5E44-44C8-ADDE-86FD48731810", Campus = "Main", DepartureTime = Convert.ToDateTime("4/16/2020 10:30:00 AM"), ArrivalTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), ToNMC = true, ReturnTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), OfferClosed = false, AddressId = "00000000-0000-0000-0000-000000000000"},
                new RiderRequest { UserId = "B8C63411-A600-B238-E734-E0F4FDD505F0", RiderRequestId = "097E9CF0-793B-48E0-B851-D2DDB882ABB3", DepartureTime = Convert.ToDateTime("4/16/2020 1:30:00 PM"), ToNMC = false, AddressId = "5d56bd1d-8bf7-4c2c-8b55-984186650386" }
                );
